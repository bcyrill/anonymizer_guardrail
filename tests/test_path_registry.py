...
def test_regex_registry_loaded_at_module_init(
    ...
    cfg = SimpleNamespace(
        regex_patterns_path="",
        regex_patterns_registry="pentest=bundled:regex_pentest.yaml",
        regex_overlap_strategy="longest",
    )
    monkeypatch.setattr(regex_mod, "config", cfg)
...
def test_llm_prompt_registry_loaded_at_module_init(
    ...
    cfg = SimpleNamespace(
        ...
        llm_system_prompt_registry="pentest=bundled:llm_pentest.md",
    )
