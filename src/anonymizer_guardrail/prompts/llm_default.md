...
{"entities": [{"text": "<exact substring from input>", "type": "PERSON|ORGANIZATION|EMAIL_ADDRESS|IPV4_ADDRESS|IPV6_ADDRESS|IPV4_CIDR|IPV6_CIDR|HOSTNAME|DOMAIN|USERNAME|CREDENTIAL|TOKEN|HASH|UUID|AWS_ACCESS_KEY|JWT|PHONE|ADDRESS|OTHER"}]}
